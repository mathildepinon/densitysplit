...
#SBATCH --mem=32GB
#SBATCH --array=0-7
#SBATCH --output='/feynman/home/dphp/mp270220/logs/density_ELG_%a.log'
#SBATCH -p htc
...
python /feynman/home/dphp/mp270220/densitysplit/bin/density_split_corr.py --redshift 0.8 --nbar 0.002 --tracer ELG --imock $SLURM_ARRAY_TASK_ID --cellsize 20 --cellsize2 20 --resampler 'tophat' --smoothing_radius 10 --todo density
