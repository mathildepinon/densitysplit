...
#catalog_density.show_halos_map(plt.figure(figsize=(3.4, 3.4)), plt.gca(), positions=catalog.positions, cellsize=20, cut_direction=cut_direction, cut_idx=idx, density=True, cmap=cmap, color='C0')
#plt.xlim(0, 1000)
#plt.ylim(0, 1000)
#plt.grid(visible=False)
#plt.savefig(os.path.join(plots_dir, 'density_particles.png'), dpi=500)
#plt.close()
