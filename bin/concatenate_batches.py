...
for i in range(100):
    ...
    batch_results = np.load(output_dir+catalog_name+'_5000_mocks_densitySplit_rh_CCF_cellsize'
                            +str(cellsize)+'_randomsize'+str(randoms_size)+'_batch'+str(batch_index)+'.npy',
                            allow_pickle=True)
...
np.save(output_dir+catalog_name+'_5000_mocks_densitySplit_rh_CCF_cellsize'+str(cellsize)+'_randomsize'+str(randoms_size)+'_all', results_list)
